...
window.showHowItWorksModal = function() {
    const message = `
        <div style="text-align: left; line-height: 1.8;">
            ...
            <div style="margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid rgba(0, 255, 0, 0.3); text-align: center;">
                <a href="#contactSection" onclick="document.getElementById('modalOverlay').classList.remove('active'); setTimeout(() => document.getElementById('contactSection').scrollIntoView({behavior: 'smooth', block: 'start'}), 100);" style="color: var(--crt-green); text-decoration: none; font-size: 0.9rem; display: inline-block; padding: 0.5rem 1rem; border: 1px solid var(--crt-green); background: rgba(0, 255, 0, 0.05); transition: all 0.3s;" onmouseover="this.style.background='rgba(0, 255, 0, 0.15)'" onmouseout="this.style.background='rgba(0, 255, 0, 0.05)'">
                    💡 SUGGEST A FEATURE
                </a>
            </div>
        </div>
...
window.showRoadmapModal = function() {
    const message = `
        <div style="text-align: left; line-height: 1.8;">
            <p style="font-size: 1.1rem; color: var(--crt-green); margin-bottom: 1.5rem;"><strong>⚡ THE TEK ROADMAP</strong></p>

            <div style="margin-bottom: 1.5rem; padding: 1rem; border-left: 3px solid var(--crt-green); background: rgba(0, 255, 0, 0.05);">
                <p><strong>📍 Phase 1: ALPHA TEK (Current)</strong></p>
                <p style="margin-top: 0.5rem;">Utility-first domain registration system. Reserve your .gudtek.lol domain and start redirecting. This is the foundation - simple, fast, and functional.</p>
            </div>

            <div style="margin-bottom: 1.5rem; padding: 1rem; border-left: 3px solid rgba(0, 255, 0, 0.5); background: rgba(0, 255, 0, 0.03);">
                <p><strong>👥 Phase 2: COMMUNITY BUILDING</strong></p>
                <p style="margin-top: 0.5rem;">Grow the userbase. Connect sysadmins, crypto enthusiasts, and builders. Form a real community around utility domains.</p>
            </div>

            <div style="margin-bottom: 1.5rem; padding: 1rem; border-left: 3px solid rgba(0, 255, 0, 0.5); background: rgba(0, 255, 0, 0.03);">
                <p><strong>🎨 Phase 3: NFT CONVERSION</strong></p>
                <p style="margin-top: 0.5rem;">Convert all domains to NFTs and airdrop to existing holders. Your domain becomes tradeable on Magic Eden and Tensor. True ownership, provable scarcity.</p>
            </div>

            <div style="margin-bottom: 1.5rem; padding: 1rem; border-left: 3px solid rgba(0, 255, 0, 0.5); background: rgba(0, 255, 0, 0.03);">
                <p><strong>✅ Phase 4: MARKETPLACE VERIFICATION</strong></p>
                <p style="margin-top: 0.5rem;">Get verified on Magic Eden and Tensor. Establish floor price, enable secondary market trading, build liquidity.</p>
            </div>

            <div style="margin-bottom: 1.5rem; padding: 1rem; border-left: 3px solid rgba(0, 255, 0, 0.5); background: rgba(0, 255, 0, 0.03);">
                <p><strong>🚀 Phase 5: MAIN TLD (.gudtek)</strong></p>
                <p style="margin-top: 0.5rem;">Reserve the main .gudtek TLD. Holders of .gudtek.lol domains will be able to convert/upgrade to .gudtek domains. Early supporters get first access.</p>
            </div>

            <div style="margin-top: 1.5rem; padding: 1rem; border: 2px solid var(--crt-green); background: rgba(0, 255, 0, 0.1);">
                <p style="color: var(--crt-green);"><strong>💡 THE TEK VISION</strong></p>
                <p style="margin-top: 0.5rem;">This is a proof of concept to deploy sysadmin tools, crypto infrastructure, and real utility. We're building in public. Community first, tech second, hype never.</p>
            </div>

            <p style="margin-top: 1.5rem; opacity: 0.7; font-size: 0.85rem; text-align: center;">Stay connected. The tek evolves.</p>
    ...
    `;
    showModal('ROADMAP', message, [{ text: 'CLOSE', callback: null }]);
};
