...
<body>
    ...
    <div class="container">
        ...
        <div style="margin-top: 2rem; padding: 1.5rem 0; text-align: center; opacity: 0.8; font-size: 0.9rem; border-top: 1px solid rgba(0, 255, 0, 0.2);">
            <p style="margin-bottom: 0.75rem;">Built with ❤️ and green phosphor</p>
            <a href="https://github.com/isgudtek/dns-gudtek.lol" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 0.5rem; color: var(--crt-green); text-decoration: none; transition: all 0.3s ease;" onmouseover="this.style.textShadow='0 0 15px var(--crt-glow)'; this.style.transform='scale(1.05)'" onmouseout="this.style.textShadow=''; this.style.transform='scale(1)'">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="filter: drop-shadow(0 0 5px var(--crt-glow));">
